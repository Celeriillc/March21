...
public class TeacherEMeetingConcludedMeetingsListAdapter extends RecyclerView.Adapter<TeacherEMeetingConcludedMeetingsListAdapter.MyViewHolder>{
    ...
    public TeacherEMeetingConcludedMeetingsListAdapter(List<EMeetingScheduledMeetingsListModel> eMeetingScheduledMeetingsListModelList, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.clickableView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("Scheduled Meeting State", "Concluded");
                bundle.putString("Scheduled Meeting Scheduled Date", eMeetingScheduledMeetingsListModel.getDateScheduled());
                Intent I = new Intent(context, TeacherEMeetingMessageBoardActivity.class);
                I.putExtras(bundle);
