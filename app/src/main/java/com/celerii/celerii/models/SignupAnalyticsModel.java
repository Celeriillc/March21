...
public class SignupAnalyticsModel {
    String accountType, accountType_platform, date, sortableDate, day, month, year, platform, platform_accountType;
    String day_month, month_day, month_year, year_month, day_month_year, year_month_day;

    public SignupAnalyticsModel() {
        this.accountType = "";
    ...
    public SignupAnalyticsModel(String accountType, String date, String sortableDate, String day, String month, String year, String platform) {
