...
public class TeacherEMeetingHomeActivity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_emeeting_home);
...
//        viewPager.setCurrentItem(1);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new TeacherEMeetingScheduledMeetingsListFragment(), "Scheduled Meetings");
        adapter.addFrag(new TeacherEMeetingConcludedMeetingsListFragment(), "Concluded Meetings");
