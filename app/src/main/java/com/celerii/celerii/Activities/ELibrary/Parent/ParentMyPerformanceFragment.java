...
public class ParentMyPerformanceFragment extends Fragment {
    Context context;
    ...
    String featureName = "Parent My Performance";
    long sessionStartTime = 0;
    String sessionDurationInSeconds = "0";

    public ParentMyPerformanceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_parent_my_performance, container, false);
        ...
        mAdapter = new ELibraryMyAssignmentAdapter(eLibraryMyAssignmentModelList, activeStudent,"ParentMyPerformance", context);
    ...
    private void loadAssignmentsFromFirebase() {
        ...
        mDatabaseReference.orderByChild("submitted").equalTo(true).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                        ...
                        mDatabaseReference = mFirebaseDatabase.getReference("E Library Assignment Student Performance").child(eLibraryMyAssignmentModel.getAssignmentID()).child(activeStudentID);
                        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                count++;
                                if (dataSnapshot.exists()) {
                                    ELibraryAssignmentStudentPerformanceModel eLibraryAssignmentStudentPerformanceModel = dataSnapshot.getValue(ELibraryAssignmentStudentPerformanceModel.class);
                                    eLibraryAssignmentStudentPerformanceModel.setStudentID(dataSnapshot.getKey());
                                    ...
                                    eLibraryMyAssignmentModel.setPerformance(String.valueOf(score));
                                } else {
                    ...
                    progressLayout.setVisibility(View.GONE);
                    errorLayout.setVisibility(View.VISIBLE);
                    errorLayoutText.setText(Html.fromHtml("You haven't completed any assignments yet."));
                }
            }
