...
public class ELibraryFinishTestActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    TextView congratulations, score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int progress = (int)(((double)(Integer.parseInt(correctAnswers)) / (double)Integer.parseInt(totalQuestions)) * 100);
        String scoreString = String.valueOf(progress) + "%";
