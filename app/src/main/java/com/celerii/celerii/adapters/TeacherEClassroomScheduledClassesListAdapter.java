...
public class TeacherEClassroomScheduledClassesListAdapter extends RecyclerView.Adapter<TeacherEClassroomScheduledClassesListAdapter.MyViewHolder>{
    ...
    public TeacherEClassroomScheduledClassesListAdapter(List<EClassroomScheduledClassesListModel> eClassroomScheduledClassesListModelList, Context context) {
