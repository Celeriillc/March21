...
public class ParentELibraryHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_e_library_home);
...
//        viewPager.setCurrentItem(1);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new ParentMyAssignmentFragment(), "My Assignments");
        adapter.addFrag(new ParentMyBooksFragment(), "My Books");
        adapter.addFrag(new ParentMyPerformanceFragment(), "My Performance");
