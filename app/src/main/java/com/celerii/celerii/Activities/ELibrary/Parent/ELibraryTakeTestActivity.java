...
public class ELibraryTakeTestActivity extends AppCompatActivity {
    ...
    public TextView header, question, optionA, optionB, optionC, optionD, optionALabel, optionBLabel, optionCLabel, optionDLabel;
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (questionIndex > 0) {
                    ...
                    int progress = (int)(((double)(questionIndex + 1) / (double)questionModelList.size()) * 100);
