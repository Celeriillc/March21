...
public class EClassroomConcludedClassesListFragment extends Fragment {
    Context context;
    ...
    public EClassroomConcludedClassesListAdapter mAdapter;
    LinearLayoutManager mLayoutManager;

    String studentID = "";

    String featureUseKey = "";
    String featureName = "E Classroom Concluded Classes List";
    long sessionStartTime = 0;
    String sessionDurationInSeconds = "0";

    public EClassroomConcludedClassesListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_e_classroom_concluded_classes_list, container, false);
        ...
        mAdapter = new EClassroomConcludedClassesListAdapter(eClassroomScheduledClassesListModelList, context);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                        ...
                        if (Date.compareDates(todayDate, eClassroomScheduledClassesListModel.getDateScheduled())) {
