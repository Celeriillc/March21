...
public class TeacherSetupActivityTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_setup_two);
        ...
        if (mFirebaseUser == null){
            ...
            Intent I = new Intent(TeacherSetupActivityTwo.this, IntroSlider.class);
            startActivity(I);
            finish();
            return;
        }
...
//                    final ProgressDialog progressDialog = new ProgressDialog(TeacherSetupActivityTwo.this);
                    final CustomProgressDialogOne progressDialog = new CustomProgressDialogOne(TeacherSetupActivityTwo.this);
//                    progressDialog.setTitle("Uploading");
                    progressDialog.show();

                    mStorageReference = mFirebaseStorage.getReference().child("ProfilePictures/" + sharedPreferencesManager.getMyFirstName() + sharedPreferencesManager.getMyLastName() + ".jpg");
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    mDatabaseReference.updateChildren(updater, new DatabaseReference.CompletionListener() {
                                        ...
                                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                            applicationLauncherSharedPreferences.setLauncherActivity("TeacherSetupThree");
                                            Intent I = new Intent(TeacherSetupActivityTwo.this, TeacherMainActivityTwo.class);
                                            startActivity(I);
                                            finish();
                                        }
                                    });
...
//                            progressDialog.setMessage("Uploaded " + ((int) progress) + "%...");
                ...
                //if there is not any file
                    ...
                    applicationLauncherSharedPreferences.setLauncherActivity("TeacherSetupThree");
                    Intent I = new Intent(TeacherSetupActivityTwo.this, TeacherSetupActivityThree.class);
                    startActivity(I);
                    finish();
                }
            }
...
//            EnableRuntimePermission();
    ...
    public void EnableRuntimePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(TeacherSetupActivityTwo.this, android.Manifest.permission.CAMERA)) {
            CustomToast.whiteBackgroundBottomToast(TeacherSetupActivityTwo.this,"CAMERA permission allows us to access your CAMERA app");
        } else {
            ActivityCompat.requestPermissions(TeacherSetupActivityTwo.this,new String[]{android.Manifest.permission.CAMERA}, RequestPermissionCode);
        }
    }
