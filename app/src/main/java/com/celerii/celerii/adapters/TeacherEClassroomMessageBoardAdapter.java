...
public class TeacherEClassroomMessageBoardAdapter extends RecyclerView.Adapter<TeacherEClassroomMessageBoardAdapter.MyViewHolder>{
    ...
    public TeacherEClassroomMessageBoardAdapter(List<EClassroomMessageBoardModel> eClassroomMessageBoardModelList, Context context) {
