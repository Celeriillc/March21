...
public class ParentEMeetingConcludedMeetingsListAdapter extends RecyclerView.Adapter<ParentEMeetingConcludedMeetingsListAdapter.MyViewHolder>{
    ...
    public ParentEMeetingConcludedMeetingsListAdapter(List<EMeetingScheduledMeetingsListModel> eMeetingScheduledMeetingsListModelList, Context context) {
