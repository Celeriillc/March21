...
public class AcademicRecordTeacher {
    String classID, teacherID, schoolID, recordKey;
    String className, teacherName, schoolName;
    String term, academicYear, subject, date, sortableDate;
    String academicYear_Term, term_AcademicYear;
    String subject_AcademicYear_Term, subject_Term_AcademicYear;
    String testType, maxObtainable, percentageOfTotal, classAverage;

    public AcademicRecordTeacher() {
    }

    public AcademicRecordTeacher(String classID, String teacherID, String schoolID, String term, String academicYear, String subject, String date, String sortableDate, String academicYear_Term, String term_AcademicYear, String subject_AcademicYear_Term, String subject_Term_AcademicYear, String testType, String maxObtainable) {
