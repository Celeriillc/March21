...
public class TeacherEClassroomConcludedClassesListFragment extends Fragment {
    Context context;
    ...
    public TeacherEClassroomConcludedClassesListAdapter mAdapter;
    LinearLayoutManager mLayoutManager;
    FloatingActionButton scheduleClassFAB;

    String featureUseKey = "";
    String featureName = "Teacher E Classroom Concluded Classes List";
    long sessionStartTime = 0;
    String sessionDurationInSeconds = "0";

    public TeacherEClassroomConcludedClassesListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_teacher_e_classroom_concluded_classes_list, container, false);
        ...
        mAdapter = new TeacherEClassroomConcludedClassesListAdapter(eClassroomScheduledClassesListModelList, context);
