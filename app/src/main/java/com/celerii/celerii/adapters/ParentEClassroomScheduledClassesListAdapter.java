...
public class ParentEClassroomScheduledClassesListAdapter  extends RecyclerView.Adapter<ParentEClassroomScheduledClassesListAdapter.MyViewHolder>{
    ...
    public ParentEClassroomScheduledClassesListAdapter(List<EClassroomScheduledClassesListModel> eClassroomScheduledClassesListModelList, String activeStudent, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.clickableView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("Scheduled Class State", "Scheduled");
