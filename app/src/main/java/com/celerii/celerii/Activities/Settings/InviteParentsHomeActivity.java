...
import com.celerii.celerii.adapters.InviteParentsHomeAdapter;
...
public class InviteParentsHomeActivity extends AppCompatActivity {
    Context context;
    ...
    public InviteParentsHomeAdapter mAdapter;
    ...
    String featureName = "Invite Parents Home";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invite_parents_home);
        ...
        getSupportActionBar().setTitle("Invite Parent");
        ...
        mAdapter = new InviteParentsHomeAdapter(studentList, activeAccountID, context);
    ...
    void loadFromSharedPreferences() {
        ...
        if (classStudentsForTeacherMap == null || classStudentsForTeacherMap.size() == 0) {
            ...
            errorLayoutText.setText(Html.fromHtml("You don't have any students whose parents you can invite at this time"));
        } else {
            for (Map.Entry<String, HashMap<String, Student>> entry : classStudentsForTeacherMap.entrySet()) {
                HashMap<String, Student> classMap = classStudentsForTeacherMap.get(entry.getKey());
                for (Map.Entry<String, Student> subEntry : classMap.entrySet()) {
                    Student student = subEntry.getValue();
                    student.setStudentID(subEntry.getKey());
