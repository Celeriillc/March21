...
public class CreateEditTemplateActivity extends AppCompatActivity {
    ...
    private ArrayList<String> deletedQuestionKeys;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deletedQuestionKeys = new ArrayList<>();
        createEditTemplateHeaderModel = new CreateEditTemplateHeaderModel();
        eLibraryMyTemplateModel = new ELibraryMyTemplateModel();
        mAdapter = new CreateEditTemplateAdapter(questionModelList, deletedQuestionKeys, createEditTemplateHeaderModel, this,this);
    ...
    public void saveToCloud() {
        ...
        for (QuestionModel questionModel: questionModelList) {
            if (!questionModel.getQuestion().equals("")) {
                String questionKey;
                if (questionModel.getQuestionID().equals("")) {
                    questionKey = mFirebaseDatabase.getReference().child("E Library Assignment Template").child(mFirebaseUser.getUid()).child(key).push().getKey();
                    questionModel.setQuestionID(questionKey);
                } else {
                    questionKey = questionModel.getQuestionID();
                }
                newTemplate.put("E Library Assignment Template Questions/" + mFirebaseUser.getUid() + "/" + key + "/" + questionKey, questionModel);
            }
        }

        for (String deletedQuestionKey: deletedQuestionKeys) {
            newTemplate.put("E Library Assignment Template Questions/" + mFirebaseUser.getUid() + "/" + key + "/" + deletedQuestionKey, null);
        }
