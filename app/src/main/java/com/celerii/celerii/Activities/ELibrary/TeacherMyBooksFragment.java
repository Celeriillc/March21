...
//        myBooksErrorLayoutButton = (Button) view.findViewById(R.id.mybookserrorlayoutbutton);
        ...
        viewMoreMyBooks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, TeacherELibraryBooksListActivity.class);
                Bundle bundle = new Bundle();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                                        ...
                                        if (!myBooksListKeys.contains(eLibraryMaterialsModel.getMaterialID())) {
                                            myBooksList.add(eLibraryMaterialsModel);
                                            myBooksListKeys.add(eLibraryMaterialsModel.getMaterialID());
                                        }
                                    }
                                }
