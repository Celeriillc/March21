...
import com.celerii.celerii.adapters.ParentEClassroomScheduledClassesListAdapter;
...
public class ParentEClassroomScheduledClassesListFragment extends Fragment {
    ...
    public ParentEClassroomScheduledClassesListAdapter mAdapter;
    ...
    String featureName = "Parent E Classroom Scheduled Classes List";
    long sessionStartTime = 0;
    String sessionDurationInSeconds = "0";

    public ParentEClassroomScheduledClassesListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_parent_e_classroom_scheduled_classes_list, container, false);
        ...
        mAdapter = new ParentEClassroomScheduledClassesListAdapter(eClassroomScheduledClassesListModelList, activeStudent, context);
    ...
    public void updateBadges() {
        if (sharedPreferencesManager.getActiveAccount().equals("Parent")) {
            ...
            updateBadgesMap.put("EClassroomParentNotification/" + mFirebaseUser.getUid() + "/" + activeStudentID + "/status", false);
