...
public class ParentEMeetingMessageBoardAdapter extends RecyclerView.Adapter<ParentEMeetingMessageBoardAdapter.MyViewHolder>{
    ...
    public ParentEMeetingMessageBoardAdapter(List<EMeetingMessageBoardModel> eMeetingMessageBoardModelList, Context context) {
