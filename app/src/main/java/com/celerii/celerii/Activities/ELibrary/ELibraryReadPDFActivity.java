...
public class ELibraryReadPDFActivity extends AppCompatActivity implements DownloadFile.Listener{
    Context context;
    ...
    String featureName = "E Library PDF Reader";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_library_read_p_d_f);
...
//        pdfView = (PDFView) findViewById(R.id.pdfView);
        ...
        remotePDFViewPager = new RemotePDFViewPager(this, materialURL, this);
    ...
    public void onSuccess(String url, String destinationPath) {
        ...
        try {
            ...
            Log.d("ELibraryReadPDFActivity", e.toString());
        }
    ...
    public void onFailure(Exception e) {
        ...
        errorLayoutText.setText("An error has occurred while trying to render this book. Please try again.");
    }
