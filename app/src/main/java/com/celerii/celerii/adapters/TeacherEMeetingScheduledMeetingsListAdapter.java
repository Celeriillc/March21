...
public class TeacherEMeetingScheduledMeetingsListAdapter extends RecyclerView.Adapter<TeacherEMeetingScheduledMeetingsListAdapter.MyViewHolder>{
    ...
    public TeacherEMeetingScheduledMeetingsListAdapter(List<EMeetingScheduledMeetingsListModel> eMeetingScheduledMeetingsListModelList, Context context) {
