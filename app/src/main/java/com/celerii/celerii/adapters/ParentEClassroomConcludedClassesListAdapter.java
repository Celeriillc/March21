...
public class ParentEClassroomConcludedClassesListAdapter  extends RecyclerView.Adapter<ParentEClassroomConcludedClassesListAdapter.MyViewHolder>{
    ...
    public ParentEClassroomConcludedClassesListAdapter(List<EClassroomScheduledClassesListModel> eClassroomScheduledClassesListModelList, String activeStudent, Context context) {
