...
public class EditTeacherProfileActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    LinearLayout genderLayout, phoneNumberLayout, maritalStatusLayout;
    TextView gender, phoneNumber, maritalStatus, composeBio;
    ...
    String featureName = "Edit Teacher Profile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneNumberLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EditTeacherProfileActivity.this, EditPhoneNumberActivity.class);
    ...
    private void loadProfileInformation() {
        ...
        maritalStatus.setText(sharedPreferencesManager.getMyRelationshipStatus());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            ...
            if (byteArray == null) {
                ...
                editProfileMap.put("Teacher/" + auth.getCurrentUser().getUid() + "/maritalStatus", maritalStatus.getText().toString().trim());
                editProfileMap.put("Teacher Bio/" + auth.getCurrentUser().getUid(), composeBio.getText().toString().trim());
...
//        UpdateDataFromFirebase..populateEssentials(getBaseContext());
    ...
    private void GetImageFromGallery() {
        if (ContextCompat.checkSelfPermission(EditTeacherProfileActivity.this,
                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(EditTeacherProfileActivity.this,
